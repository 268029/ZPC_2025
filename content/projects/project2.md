...
<figure style="text-align:center; margin: .5rem 0 1rem;">
	<img src="/images/elektroschema.jpg" alt="Schéma obvodu" style="width:50%; height:auto; border-radius:6px;" />
	<figcaption style="font-size:.9rem; color:var(--muted); margin-top:.25rem;">Schéma obvodu</figcaption>
</figure>
...
<figure style="text-align:center; margin: .5rem 0 1rem;">
	<img src="/images/elektrokod.jpg" alt="Kód obvodu" style="width:50%; height:auto; border-radius:6px;" />
	<figcaption style="font-size:.9rem; color:var(--muted); margin-top:.25rem;">Kód obvodu</figcaption>
</figure>